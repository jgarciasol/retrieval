...
def parse(input_dir, output_dir, stop_words_list):
    ...
    for i, file in enumerate(files):
        ...
        with open(file, 'r', encoding='utf-8', errors='ignore') as fp:
            ...
            tokens = [token for token in stripped if token not in stop_words_list and len(token) > 1]
...
if __name__ == "__main__":
    ...
    parse(input_dir, output_dir, stop_words_list)